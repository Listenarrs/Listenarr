...
/// </summary>
public class SearchResultScorerService
{
    private readonly ILogger<SearchResultScorerService> _logger;
    ...
    public SearchResultScorerService(ILogger<SearchResultScorerService> logger)
    {
        _logger = logger;
    }
