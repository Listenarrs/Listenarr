...
### Added
- **Sort a series by reading order:** series collections now offer a "Series Position" sort (and default to it), ordering books by their position number within the existing "In Library" and "Not Added" groupings ([#626](https://github.com/Listenarrs/Listenarr/issues/626)).
