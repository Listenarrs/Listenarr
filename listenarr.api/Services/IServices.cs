...
namespace Listenarr.Api.Services
{
    ...
    public interface IConfigurationService
    {
        ...
        /// </summary>
        /// <param name="protocol">Protocol supported by the configuration</param>
        /// <param name="enabled">Filter client for enabled/disabled</param>
        /// <returns>List of download client configurations</returns>
        Task<List<DownloadClientConfiguration>> GetDownloadClientConfigurationsAsync(DownloadProtocol? protocol = null, bool? enabled = null);
