...
builder.Services.AddScoped<Listenarr.Application.Search.AudibleSimpleLookupWorkflow>();
builder.Services.AddScoped<Listenarr.Application.Search.AudibleAuthorSearchWorkflow>();
